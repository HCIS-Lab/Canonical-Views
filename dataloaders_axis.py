...
for cat in taxonomy_list:
    ...
    for model_idx, model_id in enumerate(model_list):
        ...
        for i in range(images.shape[0]):
            ...
            file_name = f"e{int(meta[i]['elev']):+03d}_a{int(meta[i]['azim']):03d}_r{int(meta[i]['roll']):03d}"
            ...
            # Write image
            pil_image.save(os.path.join(root,cat, model_id, final_name))
