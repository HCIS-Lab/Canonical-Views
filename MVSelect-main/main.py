...
def main(args):
    ...
    if 'modelnet' in args.dataset:
        ...
        #     fpath = os.path.expanduser('/nfs/wattrel/data/md0/kung/Cognitive-Inspired-View-Selection/modelnet')
        #     num_cam = 20
        elif args.dataset == 'modelnet44_208':
            fpath = os.path.expanduser('/nfs/wattrel/data/md0/kung/Cognitive-Inspired-View-Selection/modelnet')
            num_cam = 208
        else:
            raise Exception
        ...
        val_set = ModelNet40(fpath, num_cam, split='train', per_cls_instances=5)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-d', '--dataset', type=str, default='modelnet44_208',
                        choices=['wildtrack', 'multiviewx', 'modelnet40_12', 'modelnet40_20', 'scanobjectnn', 'modelnet44_208'])
